...
const Search = () => {
  ...
  return (
    <div className="flex items-center gap-2">
      <input
        type="text"
        className="rounded-full p-2 outline-none bg-white bg-opacity-50 w-full border-[6px] border-purple-400 dark:border-white dark:bg-transparent text-black dark:text-white"
        placeholder="Search"
        value={searchInput}
