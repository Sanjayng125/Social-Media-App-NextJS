...
const EditPost = ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className="w-full bg-white shadow-2xl border md:h-full md:p-3 md:rounded overflow-y-auto max-md:mb-12 dark:bg-white dark:bg-opacity-10 dark:border-none">
